...
<body>
  <div class="wrapper">
    <div class="logo">
      <img src="./public/favicon/icon.png" alt="logo" />
    </div>
    <div class="title">
      <h1>Mimoto</h1>
    </div>
    ...
    <div class="menu"><a href="#vision">Visi dan misi</a></div>
    <div class="menu"><a href="#product">Produk kami</a></div>
    <div class="menu"><a href="#contact">Kontak kami</a></div>
    <div class="menu"><a href="#about">Tentang kami</a></div>
    <div class="side-menu">
      <ul>
    ...
    <div class="content">
      ...
      <article id="client">
        ...
        <div class="list-client">
          <img src="./public/images/clients/tesla.png" alt="our client" />
          <img src="./public/images/clients/mazda.png" alt="our client" />
          <img src="./public/images/clients/kawasaki.jpg" alt="our client" />
          <img src="./public/images/clients/vespa.png" alt="our client" />
          <img src="./public/images/clients/suzuki.png" alt="our client" />
        </div>
      </article>
    </div>
  </div>
